        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                  <a class="nav-mail btn btn_nav" href="https://gaylian.net/mail/home">Mail</a>
                </li>
                <li class="nav-item">
                  <a class="nav-mail btn btn_nav" href="https://gaylian.net/mail/inbox">Mail-Inbox</a>
                </li>
                <li class="nav-item">
                  <a class="nav-mail btn btn_nav" href="https://gaylian.net/mail/spam">Mail-Spam</a>
                </li>
              </ul>
